...
RELEASE_BODY="To install with SDK: https://github.com/marvinroger/chip-alpine/releases/download/${TAG_NAME}/${TAG_NAME}.tar.gz && tar zxvf ${TAG_NAME}.tar.gz && sudo BUILDROOT_OUTPUT_DIR=alpine-build/ ./chip-fel-flash.sh"
